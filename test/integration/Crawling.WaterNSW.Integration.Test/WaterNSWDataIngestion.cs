...
{
    public class DataIngestion : IClassFixture<WaterNSWTestFixture>
    {
        private readonly WaterNSWTestFixture fixture;
        private readonly ITestOutputHelper output;

        public DataIngestion(WaterNSWTestFixture fixture, ITestOutputHelper output)
        {
