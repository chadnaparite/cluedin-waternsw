...
namespace CluedIn.Crawling.WaterNSW.Infrastructure.Installers
{
    public class InstallComponents : IWindsorInstaller
    {
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            container
                ...
                .Register(Component.For<IWaterNSWClientFactory>().AsFactory())
                .Register(Component.For<WaterNSWClient>().LifestyleTransient());
