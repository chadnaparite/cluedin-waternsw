...
{
    public class PersonRelatedEntities : BaseRelatedEntitiesProvider
    {
        public PersonRelatedEntities() : base(EntityType.Person)
        {
        }
        ...
        public override IEnumerable<SuggestedSearch> SuggestedSearches(Guid id)
        {
            return new List<SuggestedSearch>
            {
                ...
                new SuggestedSearch
                {
                    ...
                    Tokens = string.Format("{0},{1},{2}", EntityEdgeType.OwnedBy, id.ToString(), WaterNSWEntities.Location),
                    Type = "List"
                },
                new SuggestedSearch
                {
