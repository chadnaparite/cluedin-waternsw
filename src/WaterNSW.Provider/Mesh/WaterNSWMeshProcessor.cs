...
{
    public class WaterNSW_Command_MeshProcessor : BaseMeshProcessor
    {
        public WaterNSW_Command_MeshProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }

        public override Guid GetProviderId() =>
          WaterNSWConstants.ProviderId;
